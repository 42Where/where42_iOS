...
### v1.2.0 (dhyun 현동호)
- 단순한 버그 수정
### v1.3.0 (dhyun 현동호, changhyl 이창현)
- 백엔드 토큰 갱신 방식 변경에 의한 로직 수정
### v1.3.1 (changhyl 이창현)
- 버튼 사라지는 버그 수정 (이미지 파일 한글명으로 인한 누락)
### v1.4.0 (changhyl 이창현)
- 버전 업데이트 알림 기능 추가
### v1.5.0 (changhyl 이창현)
- 공지사항 기능 추가
- 업데이트 시 토큰 갱신 버그 수정
### v1.6.0 (changhyl 이창현)
- 나침반 페이지 기능 추가 (C1, C2, C5, C6, CX1, CX2)
### v1.7.0 (changhyl 이창현)
- 통계페이지 기능 추가
  - 클러스터 실시간 현황, 클러스터 iMac 사용 현황, 나의 정보, 42 Seoul 인기자리
- 카뎃 검색 시 글자 수 3글자 이상으로 변경
- 백엔드 토큰 갱신 방식 변경에 의한 로직 수정
### v1.8.0 (changhyl 이창현)
- 전반적인 UI 개선 (작업 中)
...
## 노출수
<img height="350" alt="image" src="https://github.com/user-attachments/assets/3babeaa5-651a-4b38-ad0d-ed4d71923f2b"></br>

## 다운로드 수
<img height="350" alt="image" src="https://github.com/user-attachments/assets/c9863d4c-d950-4dc6-a323-056e404d47dd"></br>

## 업데이트
<img width="600" height="500" alt="image" src="https://github.com/user-attachments/assets/6b0cb10f-ac3b-4bf5-ad86-2daf7c0378e1"></br>
2025년 2월 통계 페이지 추가 직후 2025.02.17 ~ 2025.03.02 동안 동일 기간 최다 업데이트 횟수인 45회 기록<br/>

# 📒 지원 URL 및 개인정보 처리방침

### 지원 URL
https://hodongho.notion.site/Where42-iOS-a7c4e1fae44b47b9bfa6d5a83a929629?pvs=4

### 개인정보 처리방침
https://hodongho.notion.site/976bf116290a4e55891aee69facc22ba?pvs=4

# 🎨 UI/UIX 디자인
### Figma
<img height="500" alt="image" src="https://github.com/user-attachments/assets/fe490bd4-d581-4407-8aab-b2deb40fb700"></br>
